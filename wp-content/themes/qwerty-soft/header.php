...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="https://dev.qwerty-soft.com/wp-content/uploads/2024/11/200px.png">
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-N802QKRDZ7"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-N802QKRDZ7');
</script>
</head>
